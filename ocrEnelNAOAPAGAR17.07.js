...
const getConsumoAtivoFpontaTUSDFATURADO = (pdf) => {
  ...
  console.log(dados);
  //const isOk = (dados.vlrNum != false && dados.vlrDiaEmissao != false && dados.vlrMesEmissao != false && dados.vlrAnoEmissao != false && dados.vlrCNPJ != false && dados.vlrCPF != false && dados.vlrNome != false && dados.vlrServico != false);
 // if (isOk) return dados;
